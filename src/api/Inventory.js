...
export default class Inventory extends Api {
    ...
    static controllerName = 'inventories';
    static transferControllerName = 'inventories/automatic-transfer';
    ...
    static transfer(data) {
        ...
        return Axios.post(this.API_BASE_URL + '/' + this.transferControllerName, data, config);
    }
